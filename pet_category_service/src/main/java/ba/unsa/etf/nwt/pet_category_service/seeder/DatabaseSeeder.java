...
public class DatabaseSeeder {
    ...
    private void seed() {
        ...
        createPet("Hades", "Čapljina", "http://localhost:8084/pet-photos/adult-corn-snake.jpg", "Snakes are maybe scary. This one is also named afther the God of the underworld, but it's the most friendly snake you will meet.", 1, true, r15);
